      ...
      "types": [
        {
          ...
          "tags": ["特徴1", "特徴2", "特徴3"],
          "scriptExample": "「○○様、本日はお忙しい中お越しいただきありがとうございます。○○様のお肌の状態を拝見して...」"
        },
        {
          "title": "最適スタッフタイプ2",
          "description": "このタイプのスタッフが最適な理由",
          "tags": ["特徴1", "特徴2", "特徴3"],
          "scriptExample": "「○○様専用のプランをご提案させていただきたいのですが...」"
        },
        {
          "title": "最適スタッフタイプ3",
          "description": "このタイプのスタッフが最適な理由",
          "tags": ["特徴1", "特徴2", "特徴3"],
          "scriptExample": "「データでお見せしますが、○○様の場合は...」"
        }
      ]
    },
    "serviceScripts": {
      "greeting": {
        "script": "来店時の具体的な声かけスクリプト（そのまま使用可能）",
        "purpose": "このスクリプトで達成したい目的"
      },
      "counseling": {
        "script": "カウンセリング時の具体的な声かけスクリプト（そのまま使用可能）",
        "purpose": "このスクリプトで達成したい目的"
      },
      "closing": {
        "script": "クロージング時の具体的な声かけスクリプト（そのまま使用可能）",
        "purpose": "このスクリプトで達成したい目的"
      },
      "followUp": {
        "script": "アフターフォロー時の具体的な声かけスクリプト（そのまま使用可能）",
        "purpose": "このスクリプトで達成したい目的"
      }
    }
  }
